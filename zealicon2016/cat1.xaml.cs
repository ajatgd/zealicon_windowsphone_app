...
namespace zealicon2016
{
    ...
    /// </summary>
    public sealed partial class cat1 : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                //no connection
                MessageDialog msgbox = new MessageDialog("BLACKWIDOW wants you to wait or check your internet connection");
            ...
            else
            {
                ...
                MessageDialog msgbox = new MessageDialog("PLease wait.....Your wait will be worth.....BLACKWIDOW's charm is fetching data");
                await msgbox.ShowAsync();
            }
        ...
        void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            dwl.get_data("http://zealbo.hackncs.com/events/0.json");
        }
        async void message()
        {
        ...
        void data_arrived(object sender, DownloadCompleteData e)
        {
            ...
            try
            {
                JObject row = JObject.Parse(obj[12].ToString());
                t96.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t97.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t98.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t103.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t101.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t99.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t100.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
            ...
            try
            {
                JObject row = JObject.Parse(obj[13].ToString());
                t104.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t105.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t106.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t111.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t109.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t107.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t108.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
            ...
            try
            {
                JObject row = JObject.Parse(obj[14].ToString());
                t112.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t113.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t114.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t119.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t117.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t115.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t116.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
            ...
            try
            {
                JObject row = JObject.Parse(obj[15].ToString());
                t120.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t121.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t122.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t127.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t125.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t123.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t124.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
            ...
            try
            {
                JObject row = JObject.Parse(obj[16].ToString());
                t128.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t129.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t130.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t135.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t133.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t131.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t132.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
            ...
            try
            {
                JObject row = JObject.Parse(obj[17].ToString());
                t136.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t137.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t138.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t143.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t141.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t139.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t140.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
            ...
            try
            {
                JObject row = JObject.Parse(obj[18].ToString());
                t144.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t145.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t146.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t151.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t149.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t147.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t148.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
            ...
            try
            {
                JObject row = JObject.Parse(obj[19].ToString());
                t152.Text = Regex.Replace(row["event_name"].ToString(), @"<[^>]+>|&nbsp;","").Trim();
                t153.Text = Regex.Replace(row["long_des"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t154.Text = Regex.Replace(row["rules"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t159.Text = Regex.Replace(row["prize_money"].ToString(), @"[^0-9a-zA-Z\,]+", "").Trim(); ;
                t157.Text = Regex.Replace(row["timing"].ToString(), @"<[^>]+>|&nbsp;", "").Trim(); ;

                t155.Text = Regex.Replace(row["__invalid_name__1st_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
                t156.Text = Regex.Replace(row["__invalid_name__2nd_place"].ToString(), @"<[^>]+>|&nbsp;","").Trim();;
