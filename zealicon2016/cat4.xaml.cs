...
namespace zealicon2016
{
    ...
    /// </summary>
    public sealed partial class cat4 : Page
    {
        ...
        async protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                //no connection
                MessageDialog msgbox = new MessageDialog("THOR's Hammer wants you to wait or check your internet connection");
            ...
            {
                MessageDialog msgbox = new MessageDialog("PLease wait.....Your wait will be worth.....THOR's Hammer is fetching data");
                await msgbox.ShowAsync();
            }
        }
        ...
        void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            dwl.get_data("http://zealbo.hackncs.com/events/3.json");
        }
        async void message()
        {
