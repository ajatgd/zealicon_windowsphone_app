...
namespace zealicon2016
{
    ...
    /// </summary>
    public sealed partial class cat6 : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                //no connection
                MessageDialog msgbox = new MessageDialog("HULKY HULK wants you to wait or check your internet connection");
            ...
            {
                MessageDialog msgbox = new MessageDialog("PLease wait.....Your wait will be worth.....HULKY HULK is fetching data");
                await msgbox.ShowAsync();
            }
        }
        ...
        void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            dwl.get_data("http://zealbo.hackncs.com/events/5.json");
        }
        async void message()
        {
