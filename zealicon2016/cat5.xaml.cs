...
namespace zealicon2016
{
    ...
    /// </summary>
    public sealed partial class cat5 : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                //no connection
                MessageDialog msgbox = new MessageDialog("IRON wala MAN wants you to wait or check your internet connection");
            ...
            {
                MessageDialog msgbox = new MessageDialog("PLease wait.....Your wait will be worth.....IRON wala MAN is fetching data");
                await msgbox.ShowAsync();
        ...
        void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            dwl.get_data("http://zealbo.hackncs.com/events/4.json");
        }
        async void message()
        {
